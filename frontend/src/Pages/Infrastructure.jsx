...
const Infrastructure = () => {
    ...
    const prev  = () => setLightbox((lightbox - 1 + galleryData.length) % galleryData.length);
    const next  = () => setLightbox((lightbox + 1) % galleryData.length);
        ...
        <>
            ...
            <section className="infra-section">
                <div className="container">
                    <h1 className="section-title">Our Manufacturing Facility</h1>
                    <div style={{ maxWidth: "800px", margin: "0 auto" }}>
                        <p>Spread across 30,000 square feet in New Delhi, our manufacturing facility is equipped with the latest technology and machinery to produce high-quality products efficiently and sustainably.</p>
                        <p>Our infrastructure is designed to optimize every stage of production, from raw material processing to final packaging, ensuring consistent quality and timely delivery to our clients worldwide.</p>
                        <p>We continuously invest in upgrading our facilities to incorporate eco-friendly manufacturing processes and maintain compliance with international quality standards.</p>
                    </div>
                </div>
            </section>
            ...
            {lightbox !== null && (
                <div className="lightbox-overlay" onClick={close}>
                    <div className="lightbox-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <img src={galleryData[lightbox].src} alt={galleryData[lightbox].caption} />
                        <p className="lightbox-caption">{galleryData[lightbox].caption}</p>
                        <p className="lightbox-counter">{lightbox + 1} / {galleryData.length}</p>
                    </div>
                </div>
            )}
